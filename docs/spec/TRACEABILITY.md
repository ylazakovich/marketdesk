...
| §6 | Dashboard | Partial | `src/frontend/pages/DashboardPage.tsx`, `dashboardPresentation.ts`; native command-center layout follows OpenDesign project `marketdesk-dashboard-137` without embedding prototype code | `dashboardPresentation.test.ts`; typecheck/build; OpenDesign populated/empty/error artifact validation; deployed light/dark/narrow evidence pending | Open gap: #137 |
